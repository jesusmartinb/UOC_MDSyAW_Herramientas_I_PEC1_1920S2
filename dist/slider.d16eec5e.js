...
(0, _jquery.default)(document).ready(function () {
  ...
  var btnAnterior = (0, _jquery.default)('#btnAnterior');
  var btnSiguiente = (0, _jquery.default)('#btnSiguiente'); // Se pasa el último slide al primer lugar

  (0, _jquery.default)('#slider .slide:last').insertBefore('#slider .slide:first'); // con margen negativo se vuelve a mostrar el primer slider

  slider.css('margin-left', '-100%'); // Función para que el slide se mueva a la derecha
  ...
  function moverDerecha() {
    if (!slider.is(':animated')) {
      slider.animate({
        ...
        (0, _jquery.default)('#slider .slide:first').insertAfter('#slider .slide:last');
  ...
  function moverIzquierda() {
    if (!slider.is(':animated')) {
      (0, _jquery.default)('#slider .slide:last').insertBefore('#slider .slide:first');
